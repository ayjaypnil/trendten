...
$("#submitVICE").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionVICE == null) {
                descriptionVICE = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitBR").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionBR == null) {
                descriptionBR = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitBF").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionBF == null) {
                descriptionBF = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitVerge").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionVerge == null) {
                descriptionVerge = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitBloomberg").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionBloomberg == null) {
                descriptionBloomberg = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitCNN").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionCNN == null) {
                descriptionCNN = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionFN == null) {
                descriptionFN = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitNBC").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionNBC == null) {
                descriptionNBC = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitNYT").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionNYT == null) {
                descriptionNYT = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitCNBC").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionCNBC == null) {
                descriptionCNBC = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitMSNBC").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionMSNBC == null) {
                descriptionMSNBC = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitReddit").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionReddit == null) {
                descriptionReddit = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
...
$("#submitHP").on("click", function () {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.articles.length; i++) {
            ...
            if (descriptionHP == null) {
                descriptionHP = "Apologies, Data Currently Unavailable Due To Live Refresh. Please Check Back Soon!";
            }
